...
Your task is to build out the project to the designs inside the `/designs` folder. You'll see that the original [Sketch design file has been included](./designs/sketch/myteam.sketch) in the project.
